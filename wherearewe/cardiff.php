  ...
  <div id="wawpHolder">
    <div id="wawpContent">
      <div id="leftSideWawpContent">
        <h2>Where are we?</h2>
        <h4>Providing services to Cardiff</h4>
        <p id="paragAboveListWawp"><span class="boldText paddingTitleParagWawp">We are in the county of Buckinghamshire but we provide digital &amp; print services to Cardiff.</span><br>
We are a small friendly internet company within easy reach of London. With over 10 years’ experience, we work with businesses of all sizes, with start-ups being our speciality. So if your looking for website services near Cardiff then look no further. You can browse all the areas we cover by clicking on the ‘areas we cover’ below:</p>
        ...
        <p class="paragWawp"><span class="boldText paddingTitleParagWawp">Are you looking for web designer near Cardiff?</span><br>
We provide professional web and print services at a low cost rate. If your looking for a cheap e-comerce, wordpress or static website near Cardiff then look no further. We offer amazing pricing. No need to visit, we can arrange video or telephone call to discuss your project requirements. Once we have your information and requirements we will begin the process of producing your online/offline product.</p>
        <p class="paragWawp"><span class="boldText paddingTitleParagWawp">Low cost wordpress website near you</span><br>
We don’t just design and build websites. If you are near Cardiff then we can produce business card’s, banners, flyers, magazines, artworking services and much, much more. So if you are in or near Swansea, Newport, Wrexham, Carmarthenshire, Rhondda Cynon Taf, Flintshire or Bridgend then call us today on: 01296 340890 to see how we can help.</p>
        <p class="paragWawp"><span class="boldText paddingTitleParagWawp">Cheap print designer in Cardiff and surrounding area</span><br>
Ocip offer extremely cheap website services to the Swansea area. We offer a satisfaction guarantee, so what have you got to lose? If your based near Cardiff let’s start your new website today, email us at enquiry@ocip-group.com. We cover the following postcodes within Wales: CF, CH, GL, HR, LD, LL, NP, SA, SY.</p>
      ...
      <div id="rightSideWawpContent">
          ...
          <h2 id="titleUnderMapWawp">We provide services to<br> <span class="underTitleWamp">Wales</span></h2>
          <p>Here at Ocip we not only provide website services to Cardiff but to the whole of Wales. If you are in or near any of the below towns we can help.<br>Call us today on: <span class="boldText">01296 340890</span> to discuss your online/offline marketing.</p>
  ...
  <!------------- Google Maps JavaScript ------------->
     <script src="../JS/googleMapsCardiff.js" type="text/javascript"></script>
