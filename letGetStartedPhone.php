      ...
      <div id="letsGetStartedHolderPhone">
            ...
            <!------- PRINT --------->  
                    <div id="firstDivInsideThreeDivs" class="threeDivsInsideLetsGetStarted">
                        ...
                        <div id="buttonForPrintPhone" class="buttonFindOutMoreInThreeDivs"><p>Find out more</p></div>
                    </div>
                    <div id="hiddenDivForGetStartedPrintPhone">
                          <div id="printHiddenDivForGetStartedPhone">
                            <div id="innerHolderForHidden">
                                <div id="twoThirdsOfTheInnerHolder">
                                    ...
                                    <ul class="WhereAreWeAndPrintDevDigitalUlPhone">
                ...
                <!------- DIGITAL --------->  
                    <div id="secondDivInsideThreeDivs" class="threeDivsInsideLetsGetStarted">
                        ...
                        <div class="textInsideTheThreeDivs"><p>We do digital well and in every possible way. Whether you need images adjusted or websites built, we have our finger on the pulse. Our websites are responsive and our online services substantial and intelligent. From full e-commerce through to social media campaigns, whatever you need, we produce it. Clever SEO ensures that you get noticed and that traffic flows one way; towards you.</p></div>
                         <div id="buttonForDigitalPhone" class="buttonFindOutMoreInThreeDivs"><p>Find out more</p></div>
                    </div>
                 <div id="hiddenDivForGetStartedDigitalPhone">
                   <div id="digitalHiddenDivForGetStartedPhone">
                        <div id="innerHolderForHidden">
                            <div id="twoThirdsOfTheInnerHolder">
                                <h2>Digital</h2>
                ...
                <!------- DEVELOPE --------->  
                    <div id="thirdDivInsideThreeDivs" class="threeDivsInsideLetsGetStarted developePhoneClass">
                          <div class="circleForThreeDivs"></div>
                         <div class="textNextToCircle"><p id="numberThreeDevelopmentText"><span class="circleAroundNumber">3</span>. Development</p></div>
                         <object>
                            <embed class="developmentIcon" src="MEDIA/developmentIconHtml.svg">
                        </object>
                        <div class="textInsideTheThreeDivs"><p id="developmentText">Website development is a fine art and one that only works well when it is done correctly. From our team of committed and passionate developers, you will see your designs and ideas brought to life with websites that are fully responsive, mobile friendly and created to suit your market. Your success is ours which is why we go all out to turn awesome ideas into reality.</p></div>
                         <div id="buttonForDevelopmentPhone" class="buttonFindOutMoreInThreeDivs"><p>Find out more</p></div>
                    </div>
                      <div id="hiddenDivForGetStartedDevelopmentPhone">
                       <div id="developmentHiddenDivForGetStartedPhone">
                            <div id="innerHolderForHidden">
                                <div id="twoThirdsOfTheInnerHolder">
                                    <h2>Development</h2>
                                    <h4>Complete service list we offer</h4>
                                    <p id="developmentParagraphPhoneText">With any good website, a well built one will be key to success, utilising semantic HTML and possessing fast load times. Our small team of developers (who poses a multitude of skill set) will ensure to bring your design to function. Your responsive website will be cross browser supportive, mobile &amp; tablet friendly &amp; Seo compliant.</p>
                                    <ul class="WhereAreWeAndPrintDevDigitalUlPhone">
